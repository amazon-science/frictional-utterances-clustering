...
for root, dirs, files in os.walk("data"):
    data_files.append((os.path.relpath(root, "data"), [os.path.join(root, f) for f in files]))
...
setup(
    name="frictional_utterances_clustering",
    version="1.0",
    ...
    # #    bin/REMIDA (which you can obviously change!) as a script
